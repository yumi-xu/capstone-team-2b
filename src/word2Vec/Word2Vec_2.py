...
print("begin hyperparameter tuning: " + str(datetime.now()))

# Hyperparameter tuning and training models on original data
print("Training models on original data with hyperparameter tuning...")
...
print("before sample")
print('0:', y_train.value_counts().iloc[0], '/', round(y_train.value_counts().iloc[0] / len(y_train) * 100, 2),
      '% of the dataset')
print('1:', y_train.value_counts().iloc[1], '/', round(y_train.value_counts().iloc[1] / len(y_train) * 100, 2),
      '% of the dataset')
print('2:', y_train.value_counts().iloc[2], '/', round(y_train.value_counts().iloc[2] / len(y_train) * 100, 2),
      '% of the dataset')
print('3:', y_train.value_counts().iloc[3], '/', round(y_train.value_counts().iloc[3] / len(y_train) * 100, 2),
      '% of the dataset')
...
print('0:', y_train_res.value_counts().iloc[0], '/', round(y_train_res.value_counts().iloc[0] / len(y_train_res) * 100, 2),
      '% of the dataset')
print('1:', y_train_res.value_counts().iloc[1], '/', round(y_train_res.value_counts().iloc[1] / len(y_train_res) * 100, 2),
      '% of the dataset')
print('2:', y_train_res.value_counts().iloc[2], '/', round(y_train_res.value_counts().iloc[2] / len(y_train_res) * 100, 2),
      '% of the dataset')
print('3:', y_train_res.value_counts().iloc[3], '/', round(y_train_res.value_counts().iloc[3] / len(y_train_res) * 100, 2),
      '% of the dataset')

print("begin train model: " + str(datetime.now()))
# Hyperparameter tuning and training models on SMOTE data
